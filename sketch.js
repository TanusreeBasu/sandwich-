...
function draw() {
  ...
  fill("white");
  textSize(20)  
  text("***Note Use Left-Right arrows to move the bread",350,90 )
  stroke("yellow")
  strokeWeight(6)
  fill("brown");
  textSize(25)  
  ...
  if(frameCount % 50 === 0){
    ...
    switch(rand){
      ...
      case 2 : friend.addImage(friend2);
               friend.scale = 0.8
               score=score+2;
             //  friend.setCollider("rectangle",0,0,10,10);
       break;
      ...
      case 6 : friend.addImage(friend6);
               friend.scale = 0.5
              friend.setCollider("rectangle",0,0,friend.width,10);
              score=score+2;
       break;
      case 7 : friend.addImage(friend7);
               friend.scale = 0.2
               score=score+1;
             //  friend.setCollider("circle",0,0,15);
             //  friend.debug = true;
       break;
       default : break;
    }
